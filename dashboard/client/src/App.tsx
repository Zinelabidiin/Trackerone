...
function Router() {
  return <Switch><Route path="/" component={AdminGate} /><Route path="/invite/:token" component={Invite} /><Route path="/404" component={NotFound} /><Route component={NotFound} /></Switch>;
}
